...
### ->>> using below method still needs optimization since there's
### no checks if the same data is sent over and over again which eats
...
#                 streamData[ticker] = tickerData[ticker]
